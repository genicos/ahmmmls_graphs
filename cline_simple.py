...
# Loading data
trueanalysis = open("data/cline_simple_true_8_2", "r").readlines()
trueanalysis = trueanalysis[1:]
for i in range(len(trueanalysis)):
    trueanalysis[i] = trueanalysis[i].split("\t")

falseanalysis = open("data/cline_simple_false_8_3", "r").readlines()
...
# Mapping values
value_to_i = {"100":0, "200":1, "500":2, "1000":3}
...
x = [1,2,3,4]
xlabels = ["t = 100","t = 200","t = 500","t = 1000"]
